    ...
    <PageLayout title="About World Politics AI">
      ...
      <div className="text-left space-y-4 text-[#203c39]">
        ...
        <p>
          ...
          government language and turn it into clear, easy-to-read information.
        </p>
        ...
        <p>
          We believe the best decisions are made when people have clear, honest,
          and trustworthy information. Our goal is to give everyone the tools
          they need to understand the political world around them.
        </p>
